    ...
    <div class="jumbotron">
        <ul class="nav nav-tabs">
            <li class="active pull-right">
                <a><span class='fa fa-comments-o fa-2x'></span></a>
            </li>
            <li class="pull-right">
                <a href="chatbots00.php"><span class='fa fa-th-list fa-2x'></span></a>
            </li>
        </ul>
        <div class="text-red">
            ...
            <div class="thumbnail">
                ...
                <div class="input-group input-group-lg">
                    ...
                    <span class="input-group-btn">
                        <button id="chatButton" onclick="sendMessage()" class="btn btn-red"><span class="fa fa-chevron-right"></span></button>
                    </span>
                </div>
            </div>
        </div>
